...
public partial class NamiPlay : ContentPage
{
    ...
    public async void FailCheck()
    {
        if (fallo == 1)
        {
            Ahorcado.Source = "nami_1.png";
        }
        else if (fallo == 2)
        {
            Ahorcado.Source = "nami_2.png";
        }
        else if (fallo == 3)
        {
            Ahorcado.Source = "nami_3.png";
        }
        else if (fallo == 4)
        {
            Ahorcado.Source = "nami_4.png";
        }
        else if (fallo == 5)
        {
            Ahorcado.Source = "nami_5.png";
        }
        else if (fallo == 6)
        {
            Ahorcado.Source = "nami_6.png";
