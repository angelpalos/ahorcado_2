...
public partial class LawPlay : ContentPage
{
    ...
    public async void FailCheck()
    {
        if (fallo == 1)
        {
            Ahorcado.Source = "law_1.png";
        }
        else if (fallo == 2)
        {
            Ahorcado.Source = "law_2.png";
        }
        else if (fallo == 3)
        {
            Ahorcado.Source = "law_3.png";
        }
        else if (fallo == 4)
        {
            Ahorcado.Source = "law_4.png";
        }
        else if (fallo == 5)
        {
            Ahorcado.Source = "law_5.png";
        }
        else if (fallo == 6)
        {
            Ahorcado.Source = "law_6.png";
