namespace ah
{
    ...
    {
        double n1, n2, res, result, fallo=0, pto=0, cont, max;
        bool cnt = true;
        ...
        public async void FailCheck()
        {
            if (fallo == 1)
            {
                Ahorcado.Source = "luffy_1.png";
            }
            else if (fallo == 2)
            {
                Ahorcado.Source = "luffy_2.png";
            }
            else if (fallo == 3)
            {
                Ahorcado.Source = "luffy_3.png";
            }
            else if (fallo == 4)
            {
                Ahorcado.Source = "luffy_4.png";
            }
            else if (fallo == 5)
            {
                Ahorcado.Source = "luffy_5.png";
            }
            else if (fallo == 6)
            {
                Ahorcado.Source = "luffy_6.png";
